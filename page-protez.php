      ...
      <div class="block">
        <div class="container container_big">
          <div class="help">
            ...
            <div class="help__button button button-blue open-callback" data-title="Страница: Протезирование">записаться на прием</div>
          </div>
        </div>
      </div>
      <div class="block">
        ...
        <div class="container">
          <div class="protez__info">
            <div class="protez__info-text">
              ...
              <div class="protez__info-desc">лучшим и более выгодным решением при отсутствии всех зубов является имплантация <span class="bold">“Всё на 4”</span></div>
            </div>
