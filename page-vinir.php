          ...
          <div class="result__wrap">
            <div class="result__text">
              ...
              <div class="result__box">
                ...
                <p>Качественные виниры полностью повторяют анатомическую форму и иммитируют прозрачность эмали, что
                  делает их незаметными для окружающих </p>
              </div>
              <div class="result__box">
                <div class="result__title">
                  <svg>
                ...
                <p>Ваши зубы приобретают дополнительную прочность, ведь накладки защищают ваши зубы от внешних
                  негативных воздействий</p>
              </div>
            </div>
            <div class="result__img img"><img src="<?php echo IMAGES_PATH ?>/result.jpg"
                                              alt="Какого результата мы добиваемся с помощью виниров?"></div>
          </div>
